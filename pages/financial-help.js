            ...
            >
              <div className="accordion-body  accordion__flex--column">
                ...
                <p>
                  ...
                  výdělečně činné, která nemůže vykonávat činnost z důvodu péče
                  v domácím prostředí. K možnosti zabezpečit péči v rámci rodiny
                  má přispět též možnost střídání v poskytování péče s jiným
                  členem rodiny.{' '}
                </p>
                <p>
                  O potřebě celodenní péče rozhoduje ošetřující lékař lůžkového
                  zařízení. Nárok na dlouhodobé ošetřovné vzniká v případě,
                  trvala-li hospitalizace osoby závislé na péči alespoň 7 dní, a
                  bude-li zdravotní stav této osoby vyžadovat dlouhodobou péči
                  alespoň 30 kalendářních dnů.
                </p>
                <p>
                  Na předepsaném tiskopise bude třeba předložit vyplněnou žádost
                  a k ní připojit doklad, který vydal ošetřující lékař lůžkového
                  zařízení o potřebě poskytování dlouhodobé péče. Zároveň musí
                  být připojen písemný souhlas ošetřované osoby, aby o ní
                  pečovala osoba žádající o dlouhodobé ošetřovné. Tato žádost
                  bude zaměstnavatelem odeslána na okresní správu sociálního
                  zabezpečení.{' '}
                </p>
              </div>
              <a
            ...
            >
              <div className="accordion-body  accordion__flex--column">
                <p>
                  ...
                  informací, vzdělávání nebo styku s okolím. V běžné řeči se
                  můžeme setkat i s označením příspěvek na auto, které se
                  vztahuje jen k jednomu typu pomůcky.
                </p>
                <p>
                  Při stanovení výše příspěvku se zohledňuje příjem žadatele a
                  společně posuzovaných osob. Pravidla se liší u pomůcek v ceně
                  do 10.000 korun a nad 10.000 korun. Obecně platí, že je nutná
                  spoluúčast žadatele, činí obvykle 10% ceny a její minimální
                  výše je 1.000 korun.{' '}
                </p>
                <p>
                ...
                <p>
                  Limity: Maximální výše příspěvku na zvláštní pomůcku činí 350
                  000 Kč; 400 000 Kč v případě příspěvku na zvláštní pomůcku na
                  pořízení „plošiny“. Součet vyplacených příspěvků na zvláštní
                  pomůcku nesmí v 60 kalendářních měsících po sobě jdoucích
                  přesáhnout částku 800 000 Kč; 850 000 Kč, pokud v této době
                  byl poskytnut příspěvek na zvláštní pomůcku na pořízení
                  schodišťové plošiny.{' '}
                </p>
              </div>
              <a
            ...
            >
              <div className="accordion-body  accordion__flex--column">
                <p>
                  ...
                  rozlišují podle poklesu pracovní schopnosti – invalidní důchod
                  prvního stupně při poklesu o 35 až 49 procent, invalidní
                  důchod druhého stupně při poklesu o 50 až 69 procent a třetího
                  stupně při poklesu pracovní schopnosti o 70 procent a víc. O
                  invalidní důchod se žádá na státní správě sociálního
                  zabezpečení.
                </p>{' '}
                <p>
                  Výsledkem tohoto procesu je posudek o invaliditě, který OSSZ
                  postupuje spolu s žádostí na ústředí ČSSZ, v jehož kompetenci
                  je rozhodnout o nároku na důchod a jeho výši. OSSZ posudek
                  zašle také posuzovanému občanovi, a to do 7 dnů od jeho
                  vypracování. Je důležité vědět, že posudek je jedním z
                  podkladů pro rozhodnutí o nároku na invalidní důchod a že
            ...
            >
              <div className="accordion-body  accordion__flex--column">
                <p>
                  ...
                  jsou zároveň držiteli průkazů ZTP nebo ZTTP, nebo kterým byly
                  přiznány mimořádné výhody II. a III. stupně. Příspěvek na
                  mobilitu formulář je třeba vyzvednout na krajských pobočkách
                  úřadu práce.
                </p>
                <p>
                  {' '}
                  Výše dávky: 550 Kč měsíčně. Vyplácí se tzv. zpětně, to znamená
                  do konce kalendářního měsíce následujícího po kalendářním
                  měsíci, za který náleží. Na žádost příjemce může být příspěvek
                  na mobilitu vyplácen jednou splátkou vždy za 3 kalendářní
                  měsíce, za které náležel.
                </p>
              </div>
              <a
            ...
            >
              <div className="accordion-body  accordion__flex--column">
                ...
                <p>
                  ...
                  během doby péče sociální pojištění sice nehradí, doba péče se
                  však započítává stejně jako zaměstnání do doby pojištění pro
                  důchod.{' '}
                </p>
                ...
                <p>
                  ...
                  Pokud zaměstnanec prokáže, že převážně sám dlouhodobě pečuje o
                  osobu, která se považuje za osobu závislou na pomoci jiné
                  fyzické osoby v II., III. nebo IV. stupni závislosti, může
                  požádat o kratší pracovní dobu nebo jinou vhodnou úpravu
                  stanovené týdenní pracovní doby. Zaměstnavatel je povinen vaší
                  žádosti vyhovět, nebrání-li tomu vážné provozní důvody.
                </p>
                ...
                <p>
                  ...
                  Mezi náhradní doby pojištění patří např.: doba péče o závislé
                  osoby do 10 let věku v I. stupni závislosti nebo doba péče o
                  závislé osoby na péči jiné fyzické osoby ve II., III. nebo IV.
                  stupni závislosti
                </p>
              </div>
              <a
