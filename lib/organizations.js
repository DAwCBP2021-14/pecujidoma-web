...
export function getSortedOrganizationsData(sortBy = "name", page = 1, filterByTown = null, filterByServices = null) {
  ...
  if (filterByTown) {
    ...
    organizationsData = organizationsData.filter(organization => buildSlug(organization.town) === filterByTown);
  }
  if (filterByServices) {
  ...
  if (page) {
    organizationsData = organizationsData.slice((page - 1) * PAGE_SIZE, page * PAGE_SIZE);
  }
