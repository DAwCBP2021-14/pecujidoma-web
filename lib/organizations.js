...
const organizationsDirectory = path.join(process.cwd(), 'data', 'organizations')
...
export function getSortedOrganizationsData() {
    ...
    const allOrganizationsData = fileNames.map(fileName => {
    ...
    return allOrganizationsData.sort((a, b) => {
